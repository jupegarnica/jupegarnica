...
(function() {
    ...
    function resetCurrentFiber() {
        {
            ReactDebugCurrentFrame3.getCurrentStack = null;
            current = null;
            isRendering = false;
        }
    }
    function setCurrentFiber(fiber) {
        {
            ReactDebugCurrentFrame3.getCurrentStack = getCurrentFiberStackInDev;
            current = fiber;
            isRendering = false;
        }
    }
    ...
    };
    {
        ...
        validateProperty$1 = function(tagName, name, value, eventRegistry) {
            ...
            if (eventRegistry != null) {
                ...
                if (registrationNameDependencies1.hasOwnProperty(name)) {
                    return true;
                }
        ...
        if (typeof window !== "undefined" && typeof window.dispatchEvent === "function" && typeof document !== "undefined" && typeof document.createEvent === "function") {
            ...
            invokeGuardedCallbackImpl = function invokeGuardedCallbackDev(name, func, context, a, b, c, d, e, f) {
                ...
                function handleWindowError(event) {
                    error1 = event.error;
                    didSetError = true;
                    if (error1 === null && event.colno === 0 && event.lineno === 0) {
                ...
                if (didCall && didError) {
                    if (!didSetError) {
                        ...
                        error1 = new Error("A cross-origin error was thrown. React doesn't have access to " + "the actual error object in development. " + "See https://reactjs.org/link/crossorigin-error for more information.");
                    }
                    this.onError(error1);
                }
    ...
    function getSuspenseInstanceFromFiber(fiber) {
        if (fiber.tag === SuspenseComponent) {
            ...
            if (suspenseState === null) {
                ...
                if (current1 !== null) {
                    suspenseState = current1.memoizedState;
                }
            }
            if (suspenseState !== null) {
    ...
    function hideInstance(instance) {
        ...
        if (typeof style1.setProperty === "function") {
            style1.setProperty("display", "none", "important");
        } else {
            style1.display = "none";
        }
    }
    ...
    function checkPropTypes(typeSpecs, values, location, componentName, element) {
        {
            ...
            for(var typeSpecName in typeSpecs){
                if (has1(typeSpecs, typeSpecName)) {
                    var error$1 = void 0;
                    try {
                        if (typeof typeSpecs[typeSpecName] !== "function") {
                            var err = Error((componentName || "React class") + ": " + location + " type `" + typeSpecName + "` is invalid; " + "it must be a function, usually from the `prop-types` package, but received `" + typeof typeSpecs[typeSpecName] + "`." + "This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
    ...
    function getUnmaskedContext(workInProgress, Component1, didPushOwnContextIfProvider) {
        {
            if (didPushOwnContextIfProvider && isContextProvider(Component1)) {
    ...
    function findCurrentUnmaskedContext(fiber) {
        {
            ...
            do {
                switch(node.tag){
                    ...
                    case ClassComponent:
                        {
                            var Component1 = node.type;
                            if (isContextProvider(Component1)) {
    ...
    function ChildReconciler(shouldTrackSideEffects) {
        ...
        function updateFragment(returnFiber, current3, fragment, lanes, key) {
            if (current3 === null || current3.tag !== Fragment1) {
    ...
    function cloneChildFibers(current3, workInProgress) {
        if (!(current3 === null || workInProgress.child === current3.child)) {
            {
    ...
    function renderWithHooks(current3, workInProgress, Component2, props, secondArg, nextRenderLanes) {
    ...
    function updateReducer(reducer, initialArg, init) {
        ...
        var current4 = currentHook;
        var baseQueue = current4.baseQueue;
        ...
        if (pendingQueue !== null) {
            ...
            {
                if (current4.baseQueue !== baseQueue) {
    ...
    function readFromUnsubcribedMutableSource(root2, source, getSnapshot) {
        ...
        var version1 = getVersion(source._source);
        var isSafeToReadFromSource = false;
        var currentRenderVersion = getWorkInProgressVersion(source);
        if (currentRenderVersion !== null) {
            isSafeToReadFromSource = currentRenderVersion === version1;
        } else {
            isSafeToReadFromSource = isSubsetOfLanes(renderLanes, root2.mutableReadLanes);
            if (isSafeToReadFromSource) {
                setWorkInProgressVersion(source, version1);
            }
        }
        if (isSafeToReadFromSource) {
    ...
    function forceUnmountCurrentAndReconcile(current4, workInProgress, nextChildren, renderLanes1) {
        workInProgress.child = reconcileChildFibers(workInProgress, current4.child, null, renderLanes1);
        workInProgress.child = reconcileChildFibers(workInProgress, null, nextChildren, renderLanes1);
    }
    function updateForwardRef(current4, workInProgress, Component2, nextProps, renderLanes1) {
        {
    ...
    function updateMemoComponent(current4, workInProgress, Component2, nextProps, updateLanes, renderLanes1) {
        if (current4 === null) {
            ...
            var child = createFiberFromTypeAndProps(Component2.type, null, nextProps, workInProgress, workInProgress.mode, renderLanes1);
        ...
        var currentChild = current4.child;
        if (!includesSomeLane(updateLanes, renderLanes1)) {
            var prevProps = currentChild.memoizedProps;
            var compare = Component2.compare;
            compare = compare !== null ? compare : shallowEqual;
            if (compare(prevProps, nextProps) && current4.ref === workInProgress.ref) {
                return bailoutOnAlreadyFinishedWork(current4, workInProgress, renderLanes1);
            }
        }
        workInProgress.flags |= PerformedWork;
    ...
    function updateSimpleMemoComponent(current4, workInProgress, Component2, nextProps, updateLanes, renderLanes1) {
        {
            if (workInProgress.type !== workInProgress.elementType) {
        ...
        if (current4 !== null) {
            ...
            if (shallowEqual(prevProps, nextProps) && current4.ref === workInProgress.ref && workInProgress.type === current4.type) {
                ...
                if (!includesSomeLane(renderLanes1, updateLanes)) {
                    ...
                    return bailoutOnAlreadyFinishedWork(current4, workInProgress, renderLanes1);
                } else if ((current4.flags & ForceUpdateForLegacySuspense) !== NoFlags) {
                    didReceiveUpdate = true;
                }
            }
        }
        return updateFunctionComponent(current4, workInProgress, Component2, nextProps, renderLanes1);
    }
    function updateOffscreenComponent(current4, workInProgress, renderLanes1) {
        ...
        if (nextProps.mode === "hidden" || nextProps.mode === "unstable-defer-without-hiding") {
            ...
            if (prevState !== null) {
                _subtreeRenderLanes = mergeLanes(prevState.baseLanes, renderLanes1);
                workInProgress.memoizedState = null;
            } else {
    ...
    function markRef(current4, workInProgress) {
        var ref = workInProgress.ref;
        if (current4 === null && ref !== null || current4 !== null && current4.ref !== ref) {
            workInProgress.flags |= Ref;
        }
    }
    function updateFunctionComponent(current4, workInProgress, Component2, nextProps, renderLanes1) {
        {
            if (workInProgress.type !== workInProgress.elementType) {
                var innerPropTypes = Component2.propTypes;
                if (innerPropTypes) {
        ...
        prepareToReadContext(workInProgress, renderLanes1);
        {
            ReactCurrentOwner$1.current = workInProgress;
            setIsRendering(true);
            nextChildren = renderWithHooks(current4, workInProgress, Component2, nextProps, context, renderLanes1);
            if (workInProgress.mode & StrictMode1) {
                disableLogs();
                try {
                    nextChildren = renderWithHooks(current4, workInProgress, Component2, nextProps, context, renderLanes1);
    ...
    function updateClassComponent(current4, workInProgress, Component2, nextProps, renderLanes1) {
        {
            if (workInProgress.type !== workInProgress.elementType) {
                var innerPropTypes = Component2.propTypes;
                if (innerPropTypes) {
        ...
        if (instance === null) {
            ...
            constructClassInstance(workInProgress, Component2, nextProps);
            mountClassInstance(workInProgress, Component2, nextProps, renderLanes1);
            shouldUpdate = true;
        } else if (current4 === null) {
            shouldUpdate = resumeMountClassInstance(workInProgress, Component2, nextProps, renderLanes1);
        } else {
            shouldUpdate = updateClassInstance(current4, workInProgress, Component2, nextProps, renderLanes1);
        }
        var nextUnitOfWork = finishClassComponent(current4, workInProgress, Component2, shouldUpdate, hasContext, renderLanes1);
        {
    ...
    function finishClassComponent(current4, workInProgress, Component2, shouldUpdate, hasContext, renderLanes1) {
        ...
        workInProgress.flags |= PerformedWork;
        if (current4 !== null && didCaptureError) {
    ...
    function updateHostRoot(current4, workInProgress, renderLanes1) {
        ...
        var updateQueue = workInProgress.updateQueue;
        if (!(current4 !== null && updateQueue !== null)) {
            {
        ...
        var root2 = workInProgress.stateNode;
        if (root2.hydrate && enterHydrationState(workInProgress)) {
            {
                var mutableSourceEagerHydrationData = root2.mutableSourceEagerHydrationData;
                if (mutableSourceEagerHydrationData != null) {
                    for(var i = 0; i < mutableSourceEagerHydrationData.length; i += 2){
                        var mutableSource = mutableSourceEagerHydrationData[i];
                        var version1 = mutableSourceEagerHydrationData[i + 1];
                        setWorkInProgressVersion(mutableSource, version1);
                    }
                }
            }
    ...
    function mountLazyComponent(_current, workInProgress, elementType, updateLanes, renderLanes1) {
        ...
        workInProgress.type = Component2;
        var resolvedTag = workInProgress.tag = resolveLazyComponentTag(Component2);
        ...
        switch(resolvedTag){
            case FunctionComponent:
                {
                    {
                        validateFunctionComponentInDev(workInProgress, Component2);
                        workInProgress.type = Component2 = resolveFunctionForHotReloading(Component2);
                    }
                    child = updateFunctionComponent(null, workInProgress, Component2, resolvedProps, renderLanes1);
                    return child;
                }
            case ClassComponent:
                {
                    {
                        workInProgress.type = Component2 = resolveClassForHotReloading(Component2);
                    }
                    child = updateClassComponent(null, workInProgress, Component2, resolvedProps, renderLanes1);
                    return child;
                }
            case ForwardRef:
                {
                    {
                        workInProgress.type = Component2 = resolveForwardRefForHotReloading(Component2);
                    }
                    child = updateForwardRef(null, workInProgress, Component2, resolvedProps, renderLanes1);
                    return child;
                }
            case MemoComponent:
                {
                    ...
                    child = updateMemoComponent(null, workInProgress, Component2, resolveDefaultProps(Component2.type, resolvedProps), updateLanes, renderLanes1);
                    return child;
                }
        }
        var hint = "";
    ...
    function mountIncompleteClassComponent(_current, workInProgress, Component2, nextProps, renderLanes1) {
        if (_current !== null) {
            _current.alternate = null;
            workInProgress.alternate = null;
            workInProgress.flags |= Placement;
        ...
        constructClassInstance(workInProgress, Component2, nextProps);
        mountClassInstance(workInProgress, Component2, nextProps, renderLanes1);
        return finishClassComponent(null, workInProgress, Component2, true, hasContext, renderLanes1);
    }
    function mountIndeterminateComponent(_current, workInProgress, Component2, renderLanes1) {
        if (_current !== null) {
            _current.alternate = null;
            workInProgress.alternate = null;
            workInProgress.flags |= Placement;
        ...
        var value;
        {
            ...
            setIsRendering(true);
            ReactCurrentOwner$1.current = workInProgress;
            value = renderWithHooks(null, workInProgress, Component2, props, context, renderLanes1);
            setIsRendering(false);
        }
        workInProgress.flags |= PerformedWork;
        {
        ...
        if (typeof value === "object" && value !== null && typeof value.render === "function" && value.$$typeof === undefined) {
            ...
            mountClassInstance(workInProgress, Component2, props, renderLanes1);
            return finishClassComponent(null, workInProgress, Component2, true, hasContext, renderLanes1);
        } else {
    ...
    function validateFunctionComponentInDev(workInProgress, Component2) {
        {
            if (Component2) {
    ...
    function updateSuspenseComponent(current4, workInProgress, renderLanes1) {
        ...
        if (didSuspend || shouldRemainOnFallback(suspenseContext, current4)) {
            ...
            if (current4 === null || current4.memoizedState !== null) {
        ...
        if (current4 === null) {
            ...
            if (showFallback) {
                ...
                return mountSuspensePrimaryChildren(workInProgress, nextPrimaryChildren, renderLanes1);
            }
        } else {
            ...
            if (prevState !== null) {
                ...
                if (showFallback) {
                    ...
                    _primaryChildFragment5.childLanes = getRemainingWorkInPrimaryTree(current4, renderLanes1);
                    workInProgress.memoizedState = SUSPENDED_MARKER;
    ...
    function updateSuspensePrimaryChildren(current4, workInProgress, primaryChildren, renderLanes1) {
        ...
        if ((workInProgress.mode & BlockingMode) === NoMode) {
            primaryChildFragment.lanes = renderLanes1;
        }
        primaryChildFragment.return = workInProgress;
    ...
    function scheduleWorkOnFiber(fiber, renderLanes1) {
        ...
        var alternate = fiber.alternate;
        if (alternate !== null) {
            alternate.lanes = mergeLanes(alternate.lanes, renderLanes1);
        }
    ...
    function bailoutOnAlreadyFinishedWork(current4, workInProgress, renderLanes1) {
        ...
        if (!includesSomeLane(renderLanes1, workInProgress.childLanes)) {
            return null;
        } else {
    ...
    function remountFiber(current4, oldWorkInProgress, newWorkInProgress) {
        {
            ...
            if (last !== null) {
                ...
                returnFiber.firstEffect = returnFiber.lastEffect = current4;
            }
    ...
    function beginWork(current4, workInProgress, renderLanes1) {
        ...
        {
            if (workInProgress._debugNeedsRemount && current4 !== null) {
        ...
        if (current4 !== null) {
            ...
            var newProps = workInProgress.pendingProps;
            if (oldProps !== newProps || hasContextChanged() || workInProgress.type !== current4.type) {
                didReceiveUpdate = true;
                    ...
                    case SuspenseComponent:
                        {
                            ...
                            if (state !== null) {
                                ...
                                if (includesSomeLane(renderLanes1, primaryChildLanes)) {
                ...
                if ((current4.flags & ForceUpdateForLegacySuspense) !== NoFlags) {
                    didReceiveUpdate = true;
                } else {
                    didReceiveUpdate = false;
                }
    ...
    function completeWork(current4, workInProgress, renderLanes1) {
        ...
        switch(workInProgress.tag){
            ...
            case ClassComponent:
                {
                    var Component3 = workInProgress.type;
            ...
            case HostComponent:
                {
                    ...
                    if (current4 !== null && workInProgress.stateNode != null) {
                        ...
                        if (current4.ref !== workInProgress.ref) {
            ...
            case HostText:
                {
                    ...
                    if (current4 && workInProgress.stateNode != null) {
                        var oldText = current4.memoizedProps;
            ...
            case SuspenseComponent:
                {
                    ...
                    if ((workInProgress.flags & DidCapture) !== NoFlags) {
                        workInProgress.lanes = renderLanes1;
            ...
            case SuspenseListComponent:
                {
                    ...
                    if (renderedTail === null) {
                            ...
                            if (!cannotBeSuspended) {
                                ...
                                while(row !== null){
                                    ...
                                    if (suspended !== null) {
                                        ...
                                        resetChildFibers(workInProgress, renderLanes1);
                        ...
                        if (!didSuspendAlready) {
                            ...
                            } else if (now() * 2 - renderState.renderingStartTime > getRenderTargetTime() && renderLanes1 !== OffscreenLane) {
                                workInProgress.flags |= DidCapture;
                                didSuspendAlready = true;
                                cutOffTailIfNeeded(renderState, false);
                                workInProgress.lanes = SomeRetryLane;
    ...
    function unwindWork(workInProgress, renderLanes1) {
        switch(workInProgress.tag){
            case ClassComponent:
                {
                    var Component4 = workInProgress.type;
                ...
                {
                    {
                        ...
                        if (typeof onRender === "function") {
                            {
                                onRender(finishedWork.memoizedProps.id, current4 === null ? "mount" : "update", finishedWork.actualDuration, finishedWork.treeBaseDuration, finishedWork.actualStartTime, commitTime1, finishedRoot.memoizedInteractions);
                            }
                        }
                    }
                    return;
                            ...
                            do {
                                ...
                                if (destroy !== undefined) {
                                    if ((tag & Passive$1) !== NoFlags$1) {
                                        enqueuePendingPassiveHookEffectUnmount(current4, effect);
                                    } else {
                                        {
                                            safelyCallDestroy(current4, destroy);
                                        }
                                    }
                                }
                                effect = effect.next;
            ...
            case ClassComponent:
                {
                    ...
                    if (typeof instance.componentWillUnmount === "function") {
                        safelyCallComponentWillUnmount(current4, instance);
                    }
                    return;
                }
            case HostComponent:
    ...
    function unmountHostComponents(finishedRoot, current4, renderPriorityLevel) {
        ...
        while(true){
            ...
            while(node.sibling === null){
                if (node.return === null || node.return === current4) {
                    return;
                }
                node = node.return;
        ...
        do {
            ...
            if ((completedWork.flags & Incomplete) === NoFlags) {
                ...
                if ((completedWork.mode & ProfileMode) === NoMode) {
                    next = completeWork(current5, completedWork, subtreeRenderLanes);
                } else {
        ...
        if (remainingLanes !== NoLanes) {
            {
                if (spawnedWorkDuringRender !== null) {
                    ...
                    for(var i = 0; i < expirationTimes.length; i++){
                        scheduleInteractions(root4, expirationTimes[i], root4.memoizedInteractions);
                    }
                }
        ...
        while(nextEffect !== null){
            ...
            if (!shouldFireAfterActiveInstanceBlur && focusedInstanceHandle !== null) {
                if ((nextEffect.flags & Deletion) !== NoFlags) {
                    ...
                    if (nextEffect.tag === SuspenseComponent && isSuspenseBoundaryBeingHidden(current6, nextEffect) && doesFiberContain(nextEffect, focusedInstanceHandle)) {
                        shouldFireAfterActiveInstanceBlur = true;
                    }
                }
            }
    ...
    function commitLayoutEffects(root4, committedLanes) {
        while(nextEffect !== null){
            ...
            if (flags & (Update | Callback)) {
                ...
                commitLifeCycles(root4, current8, nextEffect);
            }
            {
                if (flags & Ref) {
    ...
    function flushPassiveEffectsImpl() {
        ...
        var effect = root4.current.firstEffect;
        while(effect !== null){
    ...
    function computeThreadID(root5, lane) {
        return lane * 1000 + root5.interactionThreadID;
    }
    ...
    function resolveLazyComponentTag(Component5) {
        ...
        } else if (Component5 !== undefined && Component5 !== null) {
    ...
    function createWorkInProgress(current9, pendingProps) {
        ...
        if (workInProgress1 === null) {
            ...
            workInProgress1.pendingProps = pendingProps;
            workInProgress1.type = current9.type;
            workInProgress1.flags = NoFlags;
        ...
        workInProgress1.updateQueue = current9.updateQueue;
    ...
    function resetWorkInProgress(workInProgress1, renderLanes1) {
        workInProgress1.flags &= Placement;
        workInProgress1.nextEffect = null;
        workInProgress1.firstEffect = null;
        workInProgress1.lastEffect = null;
    ...
    function createFiberRoot(containerInfo, tag, hydrate, hydrationCallbacks) {
        var root5 = new FiberRootNode(containerInfo, tag, hydrate);
    ...
    function registerMutableSourceForHydration(root5, mutableSource) {
        ...
        if (root5.mutableSourceEagerHydrationData == null) {
            root5.mutableSourceEagerHydrationData = [
                mutableSource,
                version2
            ];
        } else {
            root5.mutableSourceEagerHydrationData.push(mutableSource, version2);
        }
    }
    ...
    function createRootImpl(container, tag, options) {
        ...
        var root5 = createContainer(container, tag, hydrate);
...
var W2 = Object.create, h1 = Object.defineProperty, Y1 = Object.getPrototypeOf, G1 = Object.prototype.hasOwnProperty, J = Object.getOwnPropertyNames, K = Object.getOwnPropertyDescriptor;
...
;
var X = (e, r, t)=>{
    if (r && typeof r == "object" || typeof r == "function") for (let o of J(r))!G1.call(e, o) && o !== "default" && h1(e, o, {
        get: ()=>r[o]
        ,
        enumerable: !(t = K(r, o)) || t.enumerable
    });
    return e;
}, Z = (e)=>X(Q(h1(e != null ? W2(Y1(e)) : {
...
var k = g3((Je, x)=>{
    "use strict";
    var P = Object.getOwnPropertySymbols, ee = Object.prototype.hasOwnProperty, re = Object.prototype.propertyIsEnumerable;
    function te(e) {
    ...
    function ne() {
        try {
            ...
            var o = Object.getOwnPropertyNames(r).map(function(c) {
                return r[c];
            });
    ...
    x.exports = ne() ? Object.assign : function(e, r) {
        for(var t, o = te(e), n, c = 1; c < arguments.length; c++){
            t = Object(arguments[c]);
            for(var f in t)ee.call(t, f) && (o[f] = t[f]);
            if (P) {
                n = P(t);
                for(var u = 0; u < n.length; u++)re.call(t, n[u]) && (o[n[u]] = t[n[u]]);
            }
        }
        return o;
    };
...
var V = g3((l)=>{
    "use strict";
    var _ = k(), s = typeof Symbol == "function" && Symbol.for, d = s ? Symbol.for("react.element") : 60103, oe = s ? Symbol.for("react.portal") : 60106, ue = s ? Symbol.for("react.fragment") : 60107, ce = s ? Symbol.for("react.strict_mode") : 60108, le = s ? Symbol.for("react.profiler") : 60114, fe = s ? Symbol.for("react.provider") : 60109, ie = s ? Symbol.for("react.context") : 60110, se = s ? Symbol.for("react.forward_ref") : 60112, pe = s ? Symbol.for("react.suspense") : 60113, ae = s ? Symbol.for("react.memo") : 60115, ye = s ? Symbol.for("react.lazy") : 60116, $ = typeof Symbol == "function" && Symbol.iterator;
    function m(e) {
    ...
    function y(e, r, t) {
        this.props = e, this.context = r, this.refs = N, this.updater = t || I;
    }
    ...
    var E = S.prototype = new q;
    E.constructor = S;
    _(E, y.prototype);
    E.isPureReactComponent = !0;
    var O = {
        current: null
    }, A = Object.prototype.hasOwnProperty, U = {
        key: !0,
        ref: !0,
        __self: !0,
        __source: !0
    ...
    function L(e, r, t) {
        ...
        if (r != null) for(o in r.ref !== void 0 && (f = r.ref), r.key !== void 0 && (c = "" + r.key), r)A.call(r, o) && !U.hasOwnProperty(o) && (n[o] = r[o]);
        ...
        if (e && e.defaultProps) for(o in u = e.defaultProps, u)n[o] === void 0 && (n[o] = u[o]);
        return {
            $$typeof: d,
            type: e,
            key: c,
    ...
    function F(e, r, t, o) {
        if (v.length) {
            var n = v.pop();
            return n.result = e, n.keyPrefix = r, n.func = t, n.context = o, n.count = 0, n;
        }
        return {
            result: e,
            keyPrefix: r,
    ...
    function w(e, r, t, o) {
        ...
        if (c) return t(o, e, r === "" ? "." + C(e, 0) : r), 1;
        if (c = 0, r = r === "" ? "." : r + ":", Array.isArray(e)) for(var f = 0; f < e.length; f++){
            n = e[f];
            var u = r + C(n, f);
            c += w(n, u, t, o);
        }
        else if (e === null || typeof e != "object" ? u = null : (u = $ && e[$] || e["@@iterator"], u = typeof u == "function" ? u : null), typeof u == "function") for(e = u.call(e), f = 0; !(n = e.next()).done;)n = n.value, u = r + C(n, f++), c += w(n, u, t, o);
        else if (n === "object") throw t = "" + e, Error(m(31, t === "[object Object]" ? "object with keys {" + Object.keys(e).join(", ") + "}" : t, ""));
        return c;
    }
    function b(e, r, t) {
        return e == null ? 0 : w(e, "", r, t);
    }
    function C(e, r) {
        return typeof e == "object" && e !== null && e.key != null ? me(e.key) : r.toString(36);
    }
    function ve(e, r) {
    ...
    function he(e, r, t) {
        ...
        e = e.func.call(e.context, r, e.count++), Array.isArray(e) ? R(e, o, t, function(c) {
            return c;
        }) : e != null && (j(e) && (e = de(e, n + (!e.key || r && r.key === e.key ? "" : ("" + e.key).replace(D, "$&/") + "/") + t)), o.push(e));
    }
    function R(e, r, t, o, n) {
        var c = "";
        t != null && (c = ("" + t).replace(D, "$&/") + "/"), r = F(r, c, o, n), b(e, he, r), M(r);
    }
    var T = {
        current: null
    };
    ...
    l.Children = {
        map: function(e, r, t) {
            if (e == null) return e;
            var o = [];
            return R(e, o, null, r, t), o;
        },
        forEach: function(e, r, t) {
            if (e == null) return e;
            r = F(null, null, r, t), b(e, ve, r), M(r);
        },
        count: function(e) {
            return b(e, function() {
                return null;
    ...
    l.cloneElement = function(e, r, t) {
        if (e == null) throw Error(m(267, e));
        var o = _({
        }, e.props), n = e.key, c = e.ref, f = e._owner;
        if (r != null) {
            if (r.ref !== void 0 && (c = r.ref, f = O.current), r.key !== void 0 && (n = "" + r.key), e.type && e.type.defaultProps) var u = e.type.defaultProps;
            for(i in r)A.call(r, i) && !U.hasOwnProperty(i) && (o[i] = r[i] === void 0 && u !== void 0 ? u[i] : r[i]);
        }
    ...
    l.useCallback = function(e, r) {
        return a().useCallback(e, r);
    };
    l.useContext = function(e, r) {
        return a().useContext(e, r);
    };
    l.useDebugValue = function() {
    };
    l.useEffect = function(e, r) {
        return a().useEffect(e, r);
    };
    l.useImperativeHandle = function(e, r, t) {
        return a().useImperativeHandle(e, r, t);
    };
    l.useLayoutEffect = function(e, r) {
        return a().useLayoutEffect(e, r);
    };
    l.useMemo = function(e, r) {
        return a().useMemo(e, r);
    };
    l.useReducer = function(e, r, t) {
...
var H = Z(z()), Ye = H;
var z1 = Object.create, K1 = Object.defineProperty, Q1 = Object.getPrototypeOf, Z1 = Object.prototype.hasOwnProperty, V1 = Object.getOwnPropertyNames, ee = Object.getOwnPropertyDescriptor;
var ne = (f)=>K1(f, "__esModule", {
        value: !0
    })
;
var te = (f, r)=>()=>(r || (r = {
        ...
        }, f(r.exports, r)), r.exports)
;
var re = (f, r, a)=>{
    if (r && typeof r == "object" || typeof r == "function") for (let l of V1(r))!Z1.call(f, l) && l !== "default" && K1(f, l, {
        get: ()=>r[l]
        ,
        enumerable: !(a = ee(r, l)) || a.enumerable
    });
    return f;
}, ae = (f)=>re(ne(K1(f != null ? z1(Q1(f)) : {
...
var J1 = te((se, $)=>{
    $.exports = (function(f) {
        ...
        function a(l) {
            ...
            return f[l].call(_.exports, _, _.exports, a), _.loaded = !0, _.exports;
        }
        return a.m = f, a.c = r, a.p = "", a(0);
    })([
        function(f, r, a) {
            "use strict";
            ...
            var l = Object.assign || function(s) {
                ...
                return function(u, E, t) {
                    return E && s(u.prototype, E), t && s(u, t), u;
                };
            }(), R = a(1), y = n(R), D = a(2), m = n(D), x = a(10), I = n(x), Y1 = a(12), L = n(Y1), g1 = a(13), p = n(g1), j = a(14), i = S(j);
            function S(s) {
                if (s && s.__esModule) return s;
                var u = {
                };
                if (s != null) for(var E in s)Object.prototype.hasOwnProperty.call(s, E) && (u[E] = s[E]);
            ...
            function h1(s, u) {
                ...
                }), u && (Object.setPrototypeOf ? Object.setPrototypeOf(s, u) : s.__proto__ = u);
            }
            var N = [
                "\u{1F519}",
                "\u23F0"
                ...
                function u(E) {
                    d(this, u);
                    var t = v(this, (u.__proto__ || Object.getPrototypeOf(u)).call(this, E));
                    return t.state = {
                        textLines: [],
                        isDone: !1
                    ...
                    }, t.delayGenerator = function(c, M, W1, U) {
                    ...
                    }, t.typeLine = function(c, M) {
                        if (!t.mounted) return Promise.resolve();
                        var W1 = c, U = t.props.onLineTyped;
                        return i.isBackspaceElement(c) ? (c.props.delay > 0 && (t.introducedDelay = c.props.delay), W1 = String("\u{1F519}").repeat(c.props.count)) : i.isDelayElement(c) && (t.introducedDelay = c.props.ms, W1 = "\u23F0"), new Promise(function(q, G1) {
                            t.setState({
                                textLines: t.state.textLines.concat([
                                    ""
                                ])
                            }, function() {
                                i.eachPromise(W1, t.typeCharacter, W1, M).then(function() {
                                    return U(W1, M);
                                }).then(q).catch(G1);
                            });
                        });
                    }, t.typeCharacter = function(c, M, W1, U) {
                        if (!t.mounted) return Promise.resolve();
                        var q = t.props.onCharacterTyped;
                        return new Promise(function(G1) {
                            ...
                            i.sleep(t.introducedDelay).then(function() {
                                ...
                                if (o && U > 0) {
                                    for(var b = U - 1, T = e[b], k1 = b; k1 >= 0 && !(T.length > 0 && !N.includes(T[0])); k1--)b = k1, T = e[b];
                                    e[b] = T.substr(0, T.length - 1);
                                } else e[U] += c;
                                t.setState({
                                    textLines: e
                                }, function() {
                                    var P = t.delayGenerator(W1, U, c, M);
                                    q(c, M), setTimeout(G1, P);
                                });
                            });
                        });
                    }, t.mounted = !1, t.linesToType = [], t.introducedDelay = null, E.children && (t.linesToType = i.extractTextFromElement(E.children)), t;
                }
                return _(u, [
                    {
                        ...
                        value: function() {
                            this.mounted = !0;
                            var t = this.props, c = t.children, M = t.startDelay;
                            c ? M > 0 && typeof window != "undefined" ? setTimeout(this.typeAllLines.bind(this), M) : this.typeAllLines() : this.onTypingDone();
                        }
                    },
                    {
                        key: "shouldComponentUpdate",
                        value: function(t, c) {
                            if (c.textLines.length !== this.state.textLines.length) return !0;
                            for(var M = 0; M < c.textLines.length; M++){
                                var W1 = this.state.textLines[M], U = c.textLines[M];
                                if (W1 !== U) return !0;
                            }
                            return this.state.isDone !== c.isDone;
                        }
                    },
                    {
                    ...
                    },
                    {
                        key: "typeAllLines",
                        value: function() {
                            var t = this, c = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : this.linesToType;
                            return i.eachPromise(c, this.typeLine).then(function() {
                    ...
                    },
                    {
                        key: "render",
                        value: function() {
                            var t = this.props, c = t.className, M = t.cursor, W2 = this.state.isDone, U = i.cloneElementWithSpecifiedText({
                                element: this.props.children,
                                textLines: this.state.textLines
                            });
                            return y.default.createElement("div", {
                                className: "Typist " + c
                            }, U, y.default.createElement(I.default, l({
                                isDone: W2
                            }, M)));
                        }
                    }
            ...
            B.propTypes = {
                ...
                avgTypingDelay: m.default.number,
                stdTypingDelay: m.default.number,
                startDelay: m.default.number,
                cursor: m.default.object,
                onCharacterTyped: m.default.func,
                onLineTyped: m.default.func,
                onTypingDone: m.default.func,
                delayGenerator: m.default.func
            }, B.defaultProps = {
                className: "",
                avgTypingDelay: 70,
                stdTypingDelay: 25,
            ...
            }, r.default = B, B.Backspace = L.default, B.Delay = p.default;
        },
        function(f, r) {
            f.exports = Ye;
        },
        ...
        function(f, r, a) {
            "use strict";
            var l = a(4), _ = a(5), R = a(6), y = a(7), D = a(8);
            f.exports = function(m, x) {
                var I = typeof Symbol == "function" && Symbol.iterator, Y1 = "@@iterator";
                function L(e) {
                    var o = e && (I && e[I] || e[Y1]);
                ...
                function S(e) {
                    if (!1) var o, w;
                    function b(k2, P, O, A, C, F, H1) {
                        if (A = A || g1, F = F || O, H1 !== y) {
                            if (x) _(!1, "Calling PropTypes validators directly is not supported by the `prop-types` package. Use `PropTypes.checkPropTypes()` to call them. Read more at http://fb.me/use-check-prop-types");
                            else if (!1) var ie;
                        }
                        return P[O] == null ? k2 ? P[O] === null ? new i("The " + C + " `" + F + "` is marked as required " + ("in `" + A + "`, but its value is `null`.")) : new i("The " + C + " `" + F + "` is marked as required in " + ("`" + A + "`, but its value is `undefined`.")) : null : e(P, O, A, C, F);
                    }
                    var T = b.bind(null, !1);
                    return T.isRequired = b.bind(null, !0), T;
                }
                function n(e) {
                    function o(w, b, T, k2, P, O) {
                        var A = w[b], C = W3(A);
                        if (C !== e) {
                            var F = U(A);
                            return new i("Invalid " + k2 + " `" + P + "` of type " + ("`" + F + "` supplied to `" + T + "`, expected ") + ("`" + e + "`."));
                        }
                        return null;
                    }
                    return S(o);
                ...
                function d() {
                    return S(l.thatReturnsNull);
                }
                function v(e) {
                    function o(w, b, T, k2, P) {
                        if (typeof e != "function") return new i("Property `" + P + "` of component `" + T + "` has invalid PropType notation inside arrayOf.");
                        var O = w[b];
                        if (!Array.isArray(O)) {
                            var A = W3(O);
                            return new i("Invalid " + k2 + " `" + P + "` of type " + ("`" + A + "` supplied to `" + T + "`, expected an array."));
                        }
                        for(var C = 0; C < O.length; C++){
                            var F = e(O, C, T, k2, P + "[" + C + "]", y);
                ...
                function h2() {
                    function e(o, w, b, T, k2) {
                        var P = o[w];
                        if (!m(P)) {
                            var O = W3(P);
                            return new i("Invalid " + T + " `" + k2 + "` of type " + ("`" + O + "` supplied to `" + b + "`, expected a single ReactElement."));
                        }
                        return null;
                    }
                    return S(e);
                ...
                function N(e) {
                    function o(w, b, T, k2, P) {
                        if (!(w[b] instanceof e)) {
                            var O = e.name || g1, A = G2(w[b]);
                            return new i("Invalid " + k2 + " `" + P + "` of type " + ("`" + A + "` supplied to `" + T + "`, expected ") + ("instance of `" + O + "`."));
                        }
                        return null;
                    }
                    return S(o);
                ...
                function B(e) {
                    if (!Array.isArray(e)) return l.thatReturnsNull;
                    function o(w, b, T, k2, P) {
                        for(var O = w[b], A = 0; A < e.length; A++)if (j(O, e[A])) return null;
                        var C = JSON.stringify(e);
                        return new i("Invalid " + k2 + " `" + P + "` of value `" + O + "` " + ("supplied to `" + T + "`, expected one of " + C + "."));
                    }
                    return S(o);
                }
                function s(e) {
                    function o(w, b, T, k2, P) {
                        if (typeof e != "function") return new i("Property `" + P + "` of component `" + T + "` has invalid PropType notation inside objectOf.");
                        var O = w[b], A = W3(O);
                        if (A !== "object") return new i("Invalid " + k2 + " `" + P + "` of type " + ("`" + A + "` supplied to `" + T + "`, expected an object."));
                ...
                function u(e) {
                    ...
                    for(var o = 0; o < e.length; o++){
                        var w = e[o];
                        if (typeof w != "function") return R(!1, "Invalid argument supplid to oneOfType. Expected an array of check functions, but received %s at index %s.", q(w), o), l.thatReturnsNull;
                    }
                    function b(T, k2, P, O, A) {
                        for(var C = 0; C < e.length; C++){
                            var F = e[C];
                            if (F(T, k2, P, O, A, y) == null) return null;
                        }
                        return new i("Invalid " + O + " `" + A + "` supplied to " + ("`" + P + "`."));
                    }
                    return S(b);
                }
                function E() {
                    function e(o, w, b, T, k2) {
                        return c(o[w]) ? null : new i("Invalid " + T + " `" + k2 + "` supplied to " + ("`" + b + "`, expected a ReactNode."));
                    }
                    return S(e);
                }
                function t(e) {
                    function o(w, b, T, k2, P) {
                        var O = w[b], A = W3(O);
                        if (A !== "object") return new i("Invalid " + k2 + " `" + P + "` of type `" + A + "` " + ("supplied to `" + T + "`, expected `object`."));
                        for(var C in e){
                            var F = e[C];
                            if (!!F) {
                                var H1 = F(O, C, T, k2, P + "." + C, y);
                                if (H1) return H1;
                            }
                        }
                        return null;
                    ...
                    switch(typeof e){
                        ...
                        case "object":
                            ...
                            if (o) {
                                var w = o.call(e), b;
                                if (o !== e.entries) {
                                    for(; !(b = w.next()).done;)if (!c(b.value)) return !1;
                ...
                function U(e) {
                    if (typeof e == "undefined" || e === null) return "" + e;
                    var o = W3(e);
                    if (o === "object") {
                ...
                function G2(e) {
                    return !e.constructor || !e.constructor.name ? g1 : e.constructor.name;
                }
                return p.checkPropTypes = D, p.PropTypes = p, p;
            };
        },
        function(f, r) {
            "use strict";
            ...
            l.thatReturns = a, l.thatReturnsFalse = a(!1), l.thatReturnsTrue = a(!0), l.thatReturnsNull = a(null), l.thatReturnsThis = function() {
                return this;
            }, l.thatReturnsArgument = function(_) {
                return _;
            }, f.exports = l;
        },
        function(f, r) {
        ...
        function(f, r, a) {
            "use strict";
            if (!1) var l, _, R, y;
            function D(m, x, I, Y1, L) {
                if (!1) {
                    for(var g2 in m)if (m.hasOwnProperty(g2)) {
                        var p;
                        try {
                        } catch (i) {
                        }
                        if (p instanceof Error && !(p.message in y)) var j;
                    }
                }
            }
            f.exports = D;
        ...
        function(f, r, a) {
            "use strict";
            var l = a(4), _ = a(5), R = a(7);
            f.exports = function() {
                function y(x, I, Y1, L, g3, p) {
                    p !== R && _(!1, "Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");
                }
                y.isRequired = y;
                function D() {
                    return y;
        ...
        function(f, r, a) {
            ...
            var l = function() {
                ...
                return function(p, j, i) {
                    return j && g3(p.prototype, j), i && g3(p, i), p;
                };
            }(), _ = a(1), R = m(_), y = a(2), D = m(y);
            a(11);
            function m(g3) {
                return g3 && g3.__esModule ? g3 : {
                    default: g3
                };
            }
            function x(g3, p) {
                if (!(g3 instanceof p)) throw new TypeError("Cannot call a class as a function");
            }
            function I(g3, p) {
                if (!g3) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                return p && (typeof p == "object" || typeof p == "function") ? p : g3;
            }
            function Y1(g3, p) {
                if (typeof p != "function" && p !== null) throw new TypeError("Super expression must either be null or a function, not " + typeof p);
                g3.prototype = Object.create(p && p.prototype, {
                    constructor: {
                        value: g3,
                        enumerable: !1,
                        writable: !0,
                ...
                }), p && (Object.setPrototypeOf ? Object.setPrototypeOf(g3, p) : g3.__proto__ = p);
            }
            var L = function(g3) {
                Y1(p, g3);
                function p(j) {
                    x(this, p);
                    var i = I(this, (p.__proto__ || Object.getPrototypeOf(p)).call(this, j));
        ...
        function(f, r, a) {
            ...
            var m = function() {
                return _.default.createElement("noscript", null);
            };
            m.componentName = "Backspace", m.propTypes = {
                count: y.default.number,
        ...
        function(f, r, a) {
            ...
            m.componentName = "Delay", m.propTypes = {
                ms: y.default.number.isRequired
            }, r.default = m;
        },
        function(f, r, a) {
            "use strict";
            ...
            var l = function() {
                function n(d, v) {
                    var h2 = [], N = !0, B = !1, s = void 0;
                    try {
                        for(var u = d[Symbol.iterator](), E; !(N = (E = u.next()).done) && (h2.push(E.value), !(v && h2.length === v)); N = !0);
                    } catch (t) {
                        B = !0, s = t;
                    } finally{
                        try {
                ...
                return function(d, v) {
                    ...
                    if (Symbol.iterator in Object(d)) return n(d, v);
                    throw new TypeError("Invalid attempt to destructure non-iterable instance");
                };
            }();
            r.gaussianRnd = x, r.eachPromise = I, r.exclude = Y2, r.isBackspaceElement = L, r.isDelayElement = g4, r.extractTextFromElement = p, r.cloneElement = j, r.cloneElementWithSpecifiedText = S;
            var _ = a(1), R = y(_);
            function y(n) {
            ...
            function D(n) {
                if (Array.isArray(n)) {
                    for(var d = 0, v = Array(n.length); d < n.length; d++)v[d] = n[d];
                    return v;
                } else return Array.from(n);
            }
            var m = r.sleep = function(d) {
                return new Promise(function(v) {
                    return d != null ? setTimeout(v, d) : v();
                });
            };
            function x(n, d) {
                for(var v = 12, h2 = 0, N = 0; N < v; N++)h2 += Math.random();
                return (h2 -= v / 2, Math.round(h2 * d) + n);
            }
            function I(n, d) {
                for(var v = arguments.length, h2 = Array(v > 2 ? v - 2 : 0), N = 2; N < v; N++)h2[N - 2] = arguments[N];
                var B = function(u, E, t) {
                ...
                return Array.from(n).reduce(B, Promise.resolve());
            }
            function Y2(n, d) {
                var v = {
                };
                for(var h2 in n)d.indexOf(h2) === -1 && (v[h2] = n[h2]);
                return v;
            }
            function L(n) {
            ...
            function p(n) {
                for(var d = n ? [
                    ...
                    var h2 = d.pop();
                    if (R.default.isValidElement(h2)) L(h2) || g4(h2) ? v.unshift(h2) : R.default.Children.forEach(h2.props.children, function(c) {
                        d.push(c);
                    });
                    else if (Array.isArray(h2)) {
                        var N = !0, B = !1, s = void 0;
                        try {
                            for(var u = h2[Symbol.iterator](), E; !(N = (E = u.next()).done); N = !0){
                                var t = E.value;
                                d.push(t);
                            }
                        } catch (c) {
            ...
            function j(n, d) {
                var v = n.type, h3 = Y2(n.props, [
                    "children"
                ]), N = new Date().getUTCMilliseconds(), B = N + Math.random() + Math.random();
                return (h3.key = "Typist-element-" + v + "-" + B, R.default.createElement.apply(R.default, [
                    v,
                    h3
                ].concat(D(d))));
            }
            function i(n, d, v) {
                ...
                var h3 = v, N = function(t) {
                    var c = i(t, d, h3), M = l(c, 2), W3 = M[0], U = M[1];
                    return (h3 = U, W3);
                }, B = R.default.isValidElement(n) && !(L(n) || g4(n));
                if (B) {
                    var s = R.default.Children.map(n.props.children, N) || [];
                    return [
                        j(n, s),
                        h3
                    ];
            ...
            function S(n) {
                var d = n.element, v = n.textLines;
                if (!!d) return i(d, v, 0)[0];
            }
        }
    ]);
});
