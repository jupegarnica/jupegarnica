...
(function () {
  ...
  function isValidElementType(type) {
    ...
    if (
      type === exports1.Fragment || type === exports1.Profiler ||
      type === REACT_DEBUG_TRACING_MODE_TYPE || type === exports1.StrictMode ||
      type === exports1.Suspense || type === REACT_SUSPENSE_LIST_TYPE ||
      type === REACT_LEGACY_HIDDEN_TYPE || enableScopeAPI
    ) {
      return true;
    }
      ...
      if (unstable_observedBits !== undefined) {
        error(
          "useContext() second argument is reserved for future " +
            "use in React. Passing it is not supported. " + "You passed: %s.%s",
  ...
  function checkPropTypes(typeSpecs, values, location, componentName, element) {
    {
      ...
      for (var typeSpecName in typeSpecs) {
        if (has(typeSpecs, typeSpecName)) {
          ...
          if (
            error$1 instanceof Error && !(error$1.message in loggedTypeFailures)
          ) {
  ...
  function validatePropTypes(element) {
    {
      ...
      if (propTypes) {
        ...
        type.PropTypes !== undefined && !propTypesMisspellWarningShown
      ) {
...
exports1.Fragment,
  ...
  exports1.Children,
  exports1.Component,
  exports1.PureComponent,
  exports1.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
  exports1.cloneElement,
  exports1.createContext,
  exports1.createElement,
  exports1.createFactory,
  exports1.createRef,
  exports1.forwardRef,
  exports1.isValidElement,
  exports1.lazy,
  exports1.memo,
  exports1.useCallback,
  exports1.useContext,
  exports1.useDebugValue,
  exports1.useEffect,
  exports1.useImperativeHandle,
  exports1.useLayoutEffect,
  exports1.useMemo,
  exports1.useReducer,
  exports1.useRef,
  exports1.useState,
  exports1.version;
const Fragment = exports1.Fragment,
  StrictMode = exports1.StrictMode,
  Profiler = exports1.Profiler,
  Suspense = exports1.Suspense,
  Children = exports1.Children,
  Component = exports1.Component,
  PureComponent = exports1.PureComponent,
  __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED =
    exports1.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
  cloneElement = exports1.cloneElement,
  createContext = exports1.createContext,
  createElement = exports1.createElement,
  createFactory = exports1.createFactory,
  createRef = exports1.createRef,
  forwardRef = exports1.forwardRef,
  isValidElement = exports1.isValidElement,
  lazy = exports1.lazy,
  memo = exports1.memo,
  useCallback = exports1.useCallback,
  useContext = exports1.useContext,
  useDebugValue = exports1.useDebugValue,
  useEffect = exports1.useEffect,
  useImperativeHandle = exports1.useImperativeHandle,
  useLayoutEffect = exports1.useLayoutEffect,
  useMemo = exports1.useMemo,
  useReducer = exports1.useReducer,
  useRef = exports1.useRef,
  useState = exports1.useState,
  version = exports1.version;
const mod = {
  default: exports1,
  Children,
  Component,
...
(function () {
  ...
  var sharedProfilingBuffer = typeof SharedArrayBuffer === "function"
    ...
    : null;
  var profilingState = sharedProfilingBuffer !== null
  ...
  function workLoop(hasTimeRemaining, initialTime) {
    ...
    while (currentTask !== null && !enableSchedulerDebugging) {
      if (
        ...
        (!hasTimeRemaining || exports2.unstable_shouldYield())
      ) {
        break;
      }
...
exports2.unstable_now,
  exports2.unstable_shouldYield,
  exports2.unstable_forceFrameRate,
  exports2.unstable_IdlePriority,
  exports2.unstable_ImmediatePriority,
  exports2.unstable_LowPriority,
  exports2.unstable_NormalPriority,
  exports2.unstable_Profiling,
  exports2.unstable_UserBlockingPriority,
  exports2.unstable_cancelCallback,
  exports2.unstable_continueExecution,
  exports2.unstable_getCurrentPriorityLevel,
  exports2.unstable_getFirstCallbackNode,
  exports2.unstable_next,
  exports2.unstable_pauseExecution,
  exports2.unstable_requestPaint,
  exports2.unstable_runWithPriority,
  exports2.unstable_scheduleCallback,
  exports2.unstable_wrapCallback;
var exports3 = {};
(function () {
  "use strict";
...
exports3.__interactionsRef,
  exports3.__subscriberRef,
  exports3.unstable_clear,
  exports3.unstable_getCurrent,
  exports3.unstable_getThreadID,
  exports3.unstable_subscribe,
  exports3.unstable_trace,
  exports3.unstable_unsubscribe,
  exports3.unstable_wrap;
var exports4 = {};
(function () {
  "use strict";
  var React = exports1;
  ...
  function PropertyInfoRecord(
    ...
    this.acceptsBooleans = type === BOOLEANISH_STRING || type === BOOLEAN ||
  ...
  function checkControlledValueProps(tagName, props) {
    {
      if (
        !(hasReadOnlyValue[props.type] || props.onChange || props.onInput ||
  ...
  function trackValueOnNode(node) {
    ...
    if (
      node.hasOwnProperty(valueField) || typeof descriptor === "undefined" ||
  ...
  var setInnerHTML = createMicrosoftUnsafeLocalFunction(function (node, html) {
    if (node.namespaceURI === Namespaces.svg) {
      if (!("innerHTML" in node)) {
        ...
        reusableSVGContainer.innerHTML = "<svg>" + html.valueOf().toString() +
          "</svg>";
  ...
  function validateProperty(tagName, name) {
    {
      if (
        hasOwnProperty$1.call(warnedProperties, name) && warnedProperties[name]
      ) {
        return true;
      }
  ...
  };
  {
    ...
    validateProperty$1 = function (tagName, name, value, eventRegistry) {
      ...
      if (
        lowerCasedName === "is" && value !== null && value !== undefined &&
        typeof value !== "string"
      ) {
        error(
      ...
      if (
        (value === "false" || value === "true") && propertyInfo !== null &&
        propertyInfo.type === BOOLEAN
      ) {
        error(
          "Received the string `%s` for the boolean attribute `%s`. " + "%s " +
            "Did you mean %s={%s}?",
          value,
          name,
          value === "false"
  ...
  function replayUnblockedEvents() {
    ...
    if (
      queuedFocus !== null && attemptReplayContinuousQueuedEvent(queuedFocus)
    ) {
      queuedFocus = null;
    }
    ...
    if (
      queuedMouse !== null && attemptReplayContinuousQueuedEvent(queuedMouse)
    ) {
      queuedMouse = null;
    }
  ...
  function lanePriorityToSchedulerPriority(lanePriority) {
    switch (lanePriority) {
      ...
      default: {
        {
          throw Error(
            "Invalid update priority: " + lanePriority +
  ...
  function dispatchEvent(
    ...
    if (
      allowReplay && hasQueuedDiscreteEvents() &&
  ...
  function shallowEqual(objA, objB) {
    ...
    if (
      typeof objA !== "object" || objA === null || typeof objB !== "object" ||
      objB === null
    ) {
      return false;
    }
  ...
  function listenToNativeEvent(
    ...
    var eventSystemFlags = arguments.length > 4 && arguments[4] !== undefined
      ? arguments[4]
      : 0;
    ...
    if (
      targetElement !== null && !isCapturePhaseListener &&
  ...
  function diffProperties(
    ...
    for (propKey in nextProps) {
      ...
      if (propKey === STYLE) {
        ...
        typeof nextProp === "object" && nextProp !== null &&
  ...
  };
  {
    ...
    updatedAncestorInfo = function (oldInfo, tag) {
      ...
      if (
        specialTags.indexOf(tag) !== -1 && tag !== "address" && tag !== "div" &&
        tag !== "p"
      ) {
  ...
  function shouldSetTextContent(type, props) {
    return type === "textarea" || type === "option" || type === "noscript" ||
  ...
  function onScheduleRoot(root, children) {
    {
      if (
        injectedHook && typeof injectedHook.onScheduleFiberRoot === "function"
      ) {
        try {
  ...
  function onCommitUnmount(fiber) {
    if (
      injectedHook && typeof injectedHook.onCommitFiberUnmount === "function"
    ) {
      try {
  ...
  var requestPaint = Scheduler_requestPaint !== undefined
  ...
  function calculateChangedBits(context, newValue, oldValue) {
    if (objectIs(oldValue, newValue)) {
      ...
      var changedBits = typeof context._calculateChangedBits === "function"
  ...
  function enqueueUpdate(fiber, update) {
    ...
    {
      if (
        currentlyProcessingQueue === sharedQueue && !didWarnUpdateInsideUpdate
      ) {
        error(
  ...
  function getStateFromUpdate(
    ...
    switch (update.tag) {
      ...
      case CaptureUpdate: {
        workInProgress.flags = workInProgress.flags & ~ShouldCapture |
          DidCapture;
      }
      case UpdateState: {
  ...
  function applyDerivedStateFromProps(
    ...
    var memoizedState = partialState === null || partialState === undefined
      ? prevState
  ...
  function constructClassInstance(workInProgress, ctor, props) {
      ...
      if ("contextType" in ctor) {
        ...
        if (!isValid && !didWarnAboutInvalidateContextType.has(ctor)) {
          ...
          if (contextType === undefined) {
            addendum = " However, it is set to undefined. " +
    ...
    {
      if (
        typeof ctor.getDerivedStateFromProps === "function" && state === null
      ) {
  ...
  function callComponentWillReceiveProps(
    ...
    if (instance.state !== oldState) {
      {
        var componentName = getComponentName(workInProgress.type) ||
          "Component";
  ...
  function updateClassInstance(
    ...
    newState = workInProgress.memoizedState;
    if (
      unresolvedOldProps === unresolvedNewProps && oldState === newState &&
  ...
  function ChildReconciler(shouldTrackSideEffects) {
    ...
    function updatePortal(returnFiber, current, portal, lanes) {
      if (
        current === null || current.tag !== HostPortal ||
    ...
    function reconcileChildrenIterator(
      ...
      for (
        ; oldFiber !== null && !step.done; newIdx++, step = newChildren.next()
      ) {
        if (oldFiber.index > newIdx) {
          nextOldFiber = oldFiber;
          oldFiber = null;
    ...
    while (node !== null) {
      if (node.tag === SuspenseComponent) {
        ...
        if (state !== null) {
          ...
          if (
            dehydrated === null || isSuspenseInstancePending(dehydrated) ||
  ...
  function renderWithHooks(
    ...
    currentlyRenderingFiber$1 = workInProgress;
    {
      ...
      ignorePreviousDependencies = current !== null &&
  ...
  function useMutableSource(hook, source, getSnapshot, subscribe) {
    ...
    if (
      ...
      !objectIs(prevSource, source) || !objectIs(prevSubscribe, subscribe)
    ) {
      var newQueue = {
        pending: null,
        dispatch: null,
  ...
  function mountImperativeHandle(ref, create, deps) {
    ...
    var effectDeps = deps !== null && deps !== undefined
      ? deps.concat([
        ref,
      ])
      : null;
  ...
  function updateOffscreenComponent(current, workInProgress, renderLanes) {
    ...
    if (
      ...
      if ((workInProgress.mode & ConcurrentMode) === NoMode) {
        ...
        var subtreeRenderLanes = prevState !== null
          ? prevState.baseLanes
          : renderLanes;
  ...
  function mountIndeterminateComponent(
    ...
    workInProgress.flags |= PerformedWork;
    {
      if (
        ...
        typeof value.render === "function" && value.$$typeof === undefined
      ) {
    ...
    if (current === null) {
      ...
      if (prevState !== null) {
        if (showFallback) {
          ...
          _primaryChildFragment3.memoizedState = prevOffscreenState === null
        ...
        if (showFallback) {
          ...
          _primaryChildFragment5.memoizedState = _prevOffscreenState === null
            ? mountSuspenseOffscreenState(renderLanes)
  ...
  function mountSuspenseFallbackChildren(
    ...
    if (
      (mode & BlockingMode) === NoMode && progressedPrimaryFragment !== null
    ) {
  ...
  function validateRevealOrder(revealOrder) {
    {
      if (
        revealOrder !== undefined && revealOrder !== "forwards" &&
  ...
  function updateSuspenseListComponent(current, workInProgress, renderLanes) {
    ...
    if (shouldForceFallback) {
      ...
      var didSuspendBefore = current !== null &&
  ...
  function beginWork(current, workInProgress, renderLanes) {
    ...
    switch (workInProgress.tag) {
      ...
      case ForwardRef: {
        ...
        var _resolvedProps2 = workInProgress.elementType === type
          ? _unresolvedProps2
      ...
      case IncompleteClassComponent: {
        ...
        var _resolvedProps4 = workInProgress.elementType === _Component3
          ? _unresolvedProps4
    ...
    }
    {
      {
        throw Error(
          "Unknown unit of work tag (" + workInProgress.tag +
            "). This error is likely caused by a bug in React. Please file an issue.",
        );
      }
    }
        ...
        if (renderedTail === null) {
          ...
          if (!didSuspendAlready) {
            ...
            if (_suspended !== null) {
              ...
              if (
                renderState.tail === null &&
                renderState.tailMode === "hidden" && !renderedTail.alternate &&
                !getIsHydrating()
              ) {
              ...
              now() * 2 - renderState.renderingStartTime >
                getRenderTargetTime() && renderLanes !== OffscreenLane
            ) {
              workInProgress.flags |= DidCapture;
              didSuspendAlready = true;
              cutOffTailIfNeeded(renderState, false);
        ...
        if (finishedWork.flags & Snapshot) {
          if (current !== null) {
            ...
            );
            {
              ...
              if (
                snapshot === undefined && !didWarnSet.has(finishedWork.type)
              ) {
  ...
  function schedulePassiveEffects(finishedWork) {
    ...
    if (lastEffect !== null) {
      ...
      do {
        ...
        if (
          (tag & Passive$1) !== NoFlags$1 && (tag & HasEffect) !== NoFlags$1
        ) {
  ...
  function requestUpdateLane(fiber) {
    ...
    if (isTransition) {
      if (currentEventPendingLanes !== NoLanes) {
        currentEventPendingLanes = mostRecentlyUpdatedRoot !== null
  ...
  function flushSync(fn, a) {
    var prevExecutionContext = executionContext;
    if (
      (prevExecutionContext & (RenderContext | CommitContext)) !== NoContext
    ) {
      {
        error(
  ...
  function prepareFreshStack(root, lanes) {
    ...
    workInProgressRootRenderLanes = subtreeRenderLanes =
  ...
  function completeUnitOfWork(unitOfWork) {
    ...
    do {
      ...
      if ((completedWork.flags & Incomplete) === NoFlags) {
        ...
        if (
          returnFiber !== null && (returnFiber.flags & Incomplete) === NoFlags
        ) {
  ...
  function resetChildLanes(completedWork) {
    ...
    if ((completedWork.mode & ProfileMode) !== NoMode) {
      ...
      var shouldBubbleActualDurations = completedWork.alternate === null ||
      ...
      var isTimedOutSuspense = completedWork.tag === SuspenseComponent &&
        completedWork.memoizedState !== null;
  ...
  function commitBeforeMutationEffects() {
    while (nextEffect !== null) {
      ...
      if (
        !shouldFireAfterActiveInstanceBlur && focusedInstanceHandle !== null
      ) {
  ...
  function flushPassiveEffects() {
    if (pendingPassiveEffectsRenderPriority !== NoPriority$1) {
      var priorityLevel = pendingPassiveEffectsRenderPriority > NormalPriority$1
        ? NormalPriority$1
  ...
  function flushPassiveEffectsImpl() {
    ...
    executionContext = prevExecutionContext;
    flushSyncCallbackQueue();
    nestedPassiveUpdateCount = rootWithPendingPassiveEffects === null
      ? 0
  ...
  function warnAboutUpdateOnNotYetMountedFiberInDEV(fiber) {
    {
      ...
      if (
        ...
        tag !== SimpleMemoComponent && tag !== Block
      ) {
        return;
      }
  ...
  function warnAboutUpdateOnUnmountedFiberInDEV(fiber) {
    {
      var tag = fiber.tag;
      if (
        tag !== HostRoot && tag !== ClassComponent &&
        tag !== FunctionComponent && tag !== ForwardRef &&
        tag !== MemoComponent && tag !== SimpleMemoComponent && tag !== Block
      ) {
        return;
      }
  ...
  function warnAboutRenderPhaseUpdatesInDEV(fiber) {
    {
      if (
        isRendering && (executionContext & RenderContext) !== NoContext &&
        ...
        switch (fiber.tag) {
          ...
          case SimpleMemoComponent: {
            ...
            if (!didWarnAboutUpdateInRenderForAnotherComponent.has(dedupeKey)) {
              ...
              var setStateComponentName = getComponentName(fiber.type) ||
                "Unknown";
              error(
  ...
  function isCompatibleFamilyForHotReloading(fiber, element) {
    {
      ...
      if (needsCompareFamilies) {
        ...
        if (
          prevFamily !== undefined && prevFamily === resolveFamily(nextType)
        ) {
          return true;
        }
      }
  ...
  function FiberNode(tag, pendingProps, key, mode) {
    ...
    }
    {
      ...
      if (
        !hasBadMapPolyfill && typeof Object.preventExtensions === "function"
      ) {
  ...
  function createRootImpl(container, tag, options) {
    ...
    var mutableSources =
      options != null && options.hydrationOptions != null &&
        options.hydrationOptions.mutableSources || null;
  ...
  function isValidContainer(node) {
    return !!(node &&
      (node.nodeType === ELEMENT_NODE || node.nodeType === DOCUMENT_NODE ||
  ...
  function shouldHydrateDueToLegacyHeuristic(container) {
    ...
    return !!(rootElement && rootElement.nodeType === ELEMENT_NODE &&
      rootElement.hasAttribute(ROOT_ATTRIBUTE_NAME));
  }
  function legacyCreateRootFromDOMContainer(container, forceHydrate) {
    var shouldHydrate = forceHydrate ||
      shouldHydrateDueToLegacyHeuristic(container);
    if (!shouldHydrate) {
      var warned = false;
      var rootSibling;
      while (rootSibling = container.lastChild) {
        {
          if (
            !warned && rootSibling.nodeType === ELEMENT_NODE &&
...
exports4.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
  exports4.createPortal,
  exports4.findDOMNode,
  exports4.flushSync,
  exports4.hydrate,
  exports4.render,
  exports4.unmountComponentAtNode,
  exports4.unstable_batchedUpdates,
  exports4.unstable_createPortal,
  exports4.unstable_renderSubtreeIntoContainer,
  exports4.version;
const __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED1 =
    exports4.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
  createPortal = exports4.createPortal,
  findDOMNode = exports4.findDOMNode,
  flushSync = exports4.flushSync,
  hydrate = exports4.hydrate,
  render = exports4.render,
  unmountComponentAtNode = exports4.unmountComponentAtNode,
  unstable_batchedUpdates = exports4.unstable_batchedUpdates,
  unstable_createPortal = exports4.unstable_createPortal,
...
const mod1 = {
  default: exports4,
  __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:
    __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED1,
  createPortal,
  findDOMNode,
  flushSync,
  hydrate,
...
var V = g((l) => {
  ...
  var _ = k(),
    ...
    oe = s ? Symbol.for("react.portal") : 60106,
    ue = s ? Symbol.for("react.fragment") : 60107,
    ce = s ? Symbol.for("react.strict_mode") : 60108,
    le = s ? Symbol.for("react.profiler") : 60114,
    fe = s ? Symbol.for("react.provider") : 60109,
    ie = s ? Symbol.for("react.context") : 60110,
    se = s ? Symbol.for("react.forward_ref") : 60112,
    pe = s ? Symbol.for("react.suspense") : 60113,
    ae = s ? Symbol.for("react.memo") : 60115,
    ye = s ? Symbol.for("react.lazy") : 60116,
  ...
  function L(e, r, t) {
    var o, n = {}, c = null, f = null;
    if (r != null) {
      for (
        o in r.ref !== void 0 && (f = r.ref),
          r.key !== void 0 && (c = "" + r.key),
          r
      ) {
        A.call(r, o) && !U.hasOwnProperty(o) && (n[o] = r[o]);
      }
    }
    ...
    if (e && e.defaultProps) {
      for (o in u = e.defaultProps, u) n[o] === void 0 && (n[o] = u[o]);
    }
    return {
      $$typeof: d,
      type: e,
    ...
    if (c = 0, r = r === "" ? "." : r + ":", Array.isArray(e)) {
      ...
      e === null || typeof e != "object"
        ...
        : (u = $ && e[$] || e["@@iterator"],
          u = typeof u == "function"
            ? u
            : null), typeof u == "function"
    ) {
      for (e = u.call(e), f = 0; !(n = e.next()).done;) {
        n = n.value, u = r + C(n, f++), c += w(n, u, t, o);
      }
    } else if (n === "object") {
      throw t = "" + e,
        Error(m(
  ...
  l.cloneElement = function (e, r, t) {
    ...
    var o = _({}, e.props), n = e.key, c = e.ref, f = e._owner;
    if (r != null) {
      if (
        r.ref !== void 0 && (c = r.ref, f = O.current),
      ...
      for (i in r) {
        A.call(r, i) && !U.hasOwnProperty(i) &&
          (o[i] = r[i] === void 0 && u !== void 0 ? u[i] : r[i]);
      }
    }
  ...
  $.exports = (function (f) {
    ...
    function (f, r, a) {
      ...
      function S(s) {
        ...
        if (s != null) {
          for (var E in s) {
            Object.prototype.hasOwnProperty.call(s, E) && (u[E] = s[E]);
          }
        }
        ...
        B = function (s) {
          ...
          function u(E) {
            ...
            return t.state = {
              ...
              t.delayGenerator = function (c, M, W, U) {
                var q = t.props.avgTypingDelay, G = t.props.stdTypingDelay;
                return t.props.delayGenerator(q, G, {
                  line: c,
                  lineIdx: M,
                  character: W,
                  charIdx: U,
                  defDelayGenerator: function () {
                    var o = arguments.length > 0 && arguments[0] !== void 0
                        ? arguments[0]
                        : q,
              ...
              t.typeLine = function (c, M) {
                ...
                var W = c, U = t.props.onLineTyped;
                return i.isBackspaceElement(c)
                  ? (c.props.delay > 0 && (t.introducedDelay = c.props.delay),
                    W = String("\u{1F519}").repeat(c.props.count))
                  : i.isDelayElement(c) &&
                    (t.introducedDelay = c.props.ms, W = "\u23F0"),
                  new Promise(function (q, G) {
                    t.setState({
                      textLines: t.state.textLines.concat([
                        "",
                      ]),
                    }, function () {
                      i.eachPromise(W, t.typeCharacter, W, M).then(function () {
                        return U(W, M);
                      }).then(q).catch(G);
                    });
                  });
              },
              t.typeCharacter = function (c, M, W, U) {
                if (!t.mounted) return Promise.resolve();
                ...
                return new Promise(function (G) {
                  ...
                  i.sleep(t.introducedDelay).then(function () {
                    ...
                    t.setState({
                      ...
                      var P = t.delayGenerator(W, U, c, M);
                      q(c, M), setTimeout(G, P);
                    });
                  });
                });
              },
              ...
              t.introducedDelay = null,
              E.children &&
              (t.linesToType = i.extractTextFromElement(E.children)),
              t;
          }
          return _(u, [
            {
              ...
              value: function () {
                ...
                c
                  ? M > 0 && typeof window != "undefined"
                    ? setTimeout(this.typeAllLines.bind(this), M)
                    : this.typeAllLines()
                  : this.onTypingDone();
              },
            },
            {
              ...
              value: function (t, c) {
                if (
                  c.textLines.length !== this.state.textLines.length
                ) {
                  return !0;
                }
                for (var M = 0; M < c.textLines.length; M++) {
                  var W = this.state.textLines[M], U = c.textLines[M];
                  if (W !== U) return !0;
                }
            ...
            },
            {
              ...
              value: function () {
                var t = this.props,
                  ...
                  M = t.cursor,
                  W = this.state.isDone,
                  U = i.cloneElementWithSpecifiedText({
    ...
    function (f, r, a) {
      ...
      f.exports = function (m, x) {
          ...
          function b(k, P, O, A, C, F, H) {
            ...
            return P[O] == null
              ? k
                ? P[O] === null
                  ? new i(
                    "The " + C + " `" + F + "` is marked as required " +
                      ("in `" + A + "`, but its value is `null`."),
                  )
                  : new i(
                    "The " + C + " `" + F + "` is marked as required in " +
        ...
        function n(e) {
          function o(w, b, T, k, P, O) {
            var A = w[b], C = W(A);
            if (C !== e) {
              var F = U(A);
              return new i(
                "Invalid " + k + " `" + P + "` of type " +
                  ("`" + F + "` supplied to `" + T + "`, expected ") +
                  ("`" + e + "`."),
              );
            }
            return null;
        ...
        function v(e) {
          function o(w, b, T, k, P) {
            if (typeof e != "function") {
              return new i(
                "Property `" + P + "` of component `" + T +
            ...
            if (!Array.isArray(O)) {
              ...
              return new i(
                "Invalid " + k + " `" + P + "` of type " +
                  ("`" + A + "` supplied to `" + T + "`, expected an array."),
              );
            }
            for (var C = 0; C < O.length; C++) {
              var F = e(O, C, T, k, P + "[" + C + "]", y);
        ...
        function N(e) {
          function o(w, b, T, k, P) {
            if (!(w[b] instanceof e)) {
              var O = e.name || g, A = G(w[b]);
              return new i(
                "Invalid " + k + " `" + P + "` of type " +
                  ("`" + A + "` supplied to `" + T + "`, expected ") +
                  ("instance of `" + O + "`."),
              );
            }
            return null;
        ...
        function B(e) {
          ...
          function o(w, b, T, k, P) {
            for (var O = w[b], A = 0; A < e.length; A++) {
              if (j(O, e[A])) return null;
            }
            var C = JSON.stringify(e);
            return new i(
              "Invalid " + k + " `" + P + "` of value `" + O + "` " +
                ("supplied to `" + T + "`, expected one of " + C + "."),
            );
          }
          return S(o);
        }
        function s(e) {
          function o(w, b, T, k, P) {
            ...
            if (A !== "object") {
              return new i(
                "Invalid " + k + " `" + P + "` of type " +
                  ("`" + A + "` supplied to `" + T + "`, expected an object."),
              );
            }
            for (var C in O) {
        ...
        function u(e) {
          ...
          function b(T, k, P, O, A) {
            for (var C = 0; C < e.length; C++) {
              var F = e[C];
              if (F(T, k, P, O, A, y) == null) return null;
            }
            return new i(
              "Invalid " + O + " `" + A + "` supplied to " + ("`" + P + "`."),
            );
          }
          return S(b);
        }
        ...
        function M(e, o) {
          return e === "symbol" || o["@@toStringTag"] === "Symbol" ||
            typeof Symbol == "function" && o instanceof Symbol;
        }
        function W(e) {
          var o = typeof e;
    ...
    function (f, r) {
      ...
      l.thatReturns = a,
        l.thatReturnsFalse = a(!1),
        l.thatReturnsTrue = a(!0),
        l.thatReturnsNull = a(null),
    ...
    function (f, r, a) {
      ...
      var l = function () {
          ...
          return function (p, j, i) {
            return j && g(p.prototype, j), i && g(p, i), p;
          };
        }(),
        _ = a(1),
        R = m(_),
      ...
      function Y(g, p) {
        ...
        g.prototype = Object.create(p && p.prototype, {
          constructor: {
            value: g,
            enumerable: !1,
            writable: !0,
      ...
      var L = function (g) {
        ...
        function p(j) {
          ...
          var i = I(
            this,
            (p.__proto__ || Object.getPrototypeOf(p)).call(this, j),
          );
          return i._isReRenderingCursor = !1,
            i.state = {
        ...
        return l(p, [
          {
            ...
            value: function (i) {
              var S = this,
                n = !this.props.isDone && i.isDone && this.props.hideWhenDone;
    ...
    function (f, r, a) {
      ...
      var l = function () {
        function n(d, v) {
          var h = [], N = !0, B = !1, s = void 0;
          try {
            for (
              var u = d[Symbol.iterator](), E;
              !(N = (E = u.next()).done) &&
              (h.push(E.value), !(v && h.length === v));
              N = !0
            );
          } catch (t) {
            B = !0, s = t;
      ...
      r.gaussianRnd = x,
        r.eachPromise = I,
        r.exclude = Y,
        r.isBackspaceElement = L,
        r.isDelayElement = g,
        r.extractTextFromElement = p,
        r.cloneElement = j,
        r.cloneElementWithSpecifiedText = S;
      var _ = a(1), R = y(_);
      function y(n) {
      ...
      function x(n, d) {
        for (var v = 12, h = 0, N = 0; N < v; N++) h += Math.random();
        return h -= v / 2, Math.round(h * d) + n;
      }
      function I(n, d) {
        for (
          var v = arguments.length, h = Array(v > 2 ? v - 2 : 0), N = 2;
          N < v;
          N++
        ) {
          h[N - 2] = arguments[N];
      ...
      function Y(n, d) {
        var v = {};
        for (var h in n) d.indexOf(h) === -1 && (v[h] = n[h]);
        return v;
      }
      function L(n) {
      ...
      function p(n) {
        for (
          ...
          var h = d.pop();
          if (R.default.isValidElement(h)) {
            L(h) || g(h)
              ? v.unshift(h)
              : R.default.Children.forEach(h.props.children, function (c) {
                d.push(c);
              });
      ...
      function j(n, d) {
        var v = n.type,
          ...
          B = N + Math.random() + Math.random();
        return h.key = "Typist-element-" + v + "-" + B,
          R.default.createElement.apply(
            R.default,
            [
              v,
              h,
      ...
      function i(n, d, v) {
        ...
        var h = v,
          N = function (t) {
            var c = i(t, d, h), M = l(c, 2), W = M[0], U = M[1];
            return h = U, W;
          },
          B = R.default.isValidElement(n) && !(L(n) || g(n));
        if (B) {
...
function App() {
  ...
  return react.createElement(
    ...
    react.createElement(
      ...
      react.createElement("div", null, "Hi ", react.createElement(Hand, null)),
      react.createElement("div", null, "I am a web developer,"),
      react.createElement("div", null, "a web artist in love with minimalism."),
      react.createElement(
        "div",
        null,
        "My thoughts are on",
...
mod1.render(
  react.createElement(rest.StrictMode, null, react.createElement(App, null)),
